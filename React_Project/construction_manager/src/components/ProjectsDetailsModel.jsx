...
const ProjectsDetailsModel = ({ selectedProject }) => {
  ...
  return (
    <div className="modal fade" id="projectDetailsModal" tabIndex="-1" aria-labelledby="projectDetailsModalLabel" aria-hidden="true">
      <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <p><strong>Start Date:</strong> {formatDate(selectedProject.startDate) || "N/A"}</p>
